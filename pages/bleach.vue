<template>
  <div class="min-h-screen relative bg-navy-900 overflow-hidden">
    ...
    <!-- Bannière Hero -->
    <div class="banner-container h-[500px] w-full bg-landing-bleach bg-cover bg-center bg-no-repeat relative flex flex-col justify-center items-center text-center">
      ...
      <div class="relative z-10 flex flex-col items-center gap-4 transform slide-in-top max-w-[1400px] sm:max-w-[95%] px-4">
        <h1 class="text-7xl sm:text-5xl md:text-6xl font-bold text-white glow-text">
          <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-800 animate-gradient">{{ $t('bleach.hero.title') }}</span>
        </h1>
        <p class="text-gray-300 max-w-2xl text-center text-xl mt-4">{{ $t('bleach.hero.subtitle') }}</p>
        ...
        <div class="flex gap-6 mt-8">
          ...
          <a :href="$t('links.bleachWiki')" target="_blank" class="px-6 py-3 bg-navy-800 hover:bg-navy-700 text-white rounded-lg flex items-center gap-2 transition-all duration-300 hover:scale-105 border border-blue-500/30 hover:border-blue-500/50">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="text-white">
    ...
    <div class="mx-auto max-w-[80%] sm:max-w-[95%] py-20">
      ...
      <section class="mb-24">
        <div class="text-center mb-12">
          <h2 class="text-5xl md:4-xl sm:3-xl font-bold text-white mb-6 glow-text">{{ $t('bleach.welcome.title') }}</h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-1 gap-12 items-center">
          <div class="fade-in-section">
            <p class="text-gray-300 text-lg leading-relaxed mb-6">
              {{ $t('bleach.welcome.paragraph1') }}
            </p>
            <p class="text-gray-300 text-lg leading-relaxed mb-6">
              {{ $t('bleach.welcome.paragraph2') }}
            </p>
            <p class="text-gray-300 text-lg leading-relaxed">
              {{ $t('bleach.welcome.paragraph3') }}
            </p>
          </div>
          ...
          <div class="relative rounded-xl overflow-hidden fade-in-section">
            ...
            <div class="group relative overflow-hidden rounded-xl">
              <img src="/assets/images/boutique/bleach_wallpaper.webp" alt="Bleach Universe" class="w-full h-full object-cover rounded-xl transition-transform duration-700 group-hover:scale-110">
              ...
              <div class="absolute inset-0 bg-gradient-to-t from-navy-900/90 via-navy-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                <h3 class="text-white text-2xl font-bold mb-2">{{ $t('bleach.welcome.explore') }}</h3>
                <p class="text-gray-300">{{ $t('bleach.welcome.exploreDesc') }}</p>
              </div>
      ...
      <section id="wiki" class="relative ">
        <div class="text-center mb-12 relative z-10">
          <h2 class="text-5xl md:4-xl sm:3-xl font-bold text-white mb-6 glow-text">{{ $t('bleach.resources.title') }}</h2>
          <div class="w-24 h-1 bg-gradient-to-r from-blue-500 to-blue-800 mx-auto"></div>
          <p class="text-gray-300 text-lg max-w-2xl mx-auto mt-4">
            {{ $t('bleach.resources.subtitle') }}
          </p>
        </div>
            ...
            <div class="space-y-4">
              <a href="/reglement-general" class="block p-4 bg-navy-900 rounded-lg border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:shadow-md group">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <h4 class="text-white text-lg font-medium group-hover:text-blue-300 transition-colors duration-300">{{ $t('bleach.resources.general') }}</h4>
                    <p class="text-gray-400 text-sm group-hover:text-gray-300 transition-colors duration-300">{{ $t('bleach.resources.generalDesc') }}</p>
                  </div>
                </div>
              ...
              <a href="/reglement-demons" class="block p-4 bg-navy-900 rounded-lg border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:shadow-md group">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <h4 class="text-white text-lg font-medium group-hover:text-red-300 transition-colors duration-300">{{ $t('bleach.resources.demons') }}</h4>
                    <p class="text-gray-400 text-sm group-hover:text-gray-300 transition-colors duration-300">{{ $t('bleach.resources.demonsDesc') }}</p>
                  </div>
                </div>
                <div class="mt-3 flex justify-end">
              ...
              <a href="/reglement-pourfendeurs" class="block p-4 bg-navy-900 rounded-lg border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:shadow-md group">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <h4 class="text-white text-lg font-medium group-hover:text-green-300 transition-colors duration-300">{{ $t('bleach.resources.slayers') }}</h4>
                    <p class="text-gray-400 text-sm group-hover:text-gray-300 transition-colors duration-300">{{ $t('bleach.resources.slayersDesc') }}</p>
                  </div>
                </div>
                <div class="mt-3 flex justify-end">
          ...
          <div class="bg-navy-800 rounded-xl p-8 border border-blue-500/30 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 h-full">
            ...
            <div class="bg-navy-900 rounded-lg p-6 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:shadow-md">
              <div class="flex flex-col md:flex-col gap-6 items-center">
                ...
                <div>
                  <h4 class="text-white text-xl font-medium mb-2">{{ $t('bleach.wiki.subtitle') }}</h4>
                  <p class="text-gray-400 mb-4">{{ $t('bleach.wiki.description') }}</p>
                  ...
                  <div class="space-y-2">
                    <div class="flex items-center gap-2 text-gray-300">
                      ...
                      <span>{{ $t('bleach.wiki.feature1') }}</span>
                    </div>
                    <div class="flex items-center gap-2 text-gray-300">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" class="text-blue-400">
                        <path fill="currentColor" d="M9 16.17L4.83 12l-1.42 1.41L9 19L21 7l-1.41-1.41z"/>
                      </svg>
                      <span>{{ $t('bleach.wiki.feature2') }}</span>
                    </div>
                    <div class="flex items-center gap-2 text-gray-300">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" class="text-blue-400">
                        <path fill="currentColor" d="M9 16.17L4.83 12l-1.42 1.41L9 19L21 7l-1.41-1.41z"/>
                      </svg>
                      <span>{{ $t('bleach.wiki.feature3') }}</span>
                    </div>
                    <div class="flex items-center gap-2 text-gray-300">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" class="text-blue-400">
                        <path fill="currentColor" d="M9 16.17L4.83 12l-1.42 1.41L9 19L21 7l-1.41-1.41z"/>
                      </svg>
                      <span>{{ $t('bleach.wiki.feature4') }}</span>
                    </div>
                  </div>
                  ...
                  <a href="https://vidolia.fr/wiki-demonslayer" target="_blank" class="mt-6 inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 text-white rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30">
                    <span>{{ $t('bleach.wiki.consult') }}</span>
    ...
    <section class="py-16 bg-landing-bleach bg-cover bg-center relative mt-20">
      ...
      <div class="mx-auto max-w-[1400px] sm:max-w-[95%] px-4 relative z-10 flex flex-col items-center text-center">
        <h2 class="text-5xl md:4-xl sm:3-xl font-bold text-white mb-4 glow-text">{{ $t('bleach.cta.title') }}</h2>
        <p class="text-gray-300 mb-8 max-w-2xl">{{ $t('bleach.cta.subtitle') }}</p>
