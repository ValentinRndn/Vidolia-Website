          ...
          <div class="grid grid-cols-2 md:grid-cols-1 gap-12 items-center">
            ...
            <div class="relative rounded-xl overflow-hidden fade-in-section">
              ...
              <div class="group relative overflow-hidden rounded-xl">
                <img src="/assets/images/boutique/bleach_wallpaper.webp" alt="Demon Slayer Universe" class="w-full h-full object-cover rounded-xl transition-transform duration-700 group-hover:scale-110">
